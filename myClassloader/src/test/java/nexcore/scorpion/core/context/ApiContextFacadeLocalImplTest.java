...
public class ApiContextFacadeLocalImplTest extends CamelSpringTestSupport {
	
	@Override
	protected AbstractApplicationContext createApplicationContext() {
		return new ClassPathXmlApplicationContext("nexcore/scorpion/core/context/ApiContextFacadeLocalImplTest.xml");
	}
	...
	public void test() throws Exception {
		...
		while(true){
			try {
				Thread.sleep(4000);
				ApiContextFacade contextFacade = context.getRegistry().lookupByNameAndType("contextFacade", ApiContextFacade.class);
