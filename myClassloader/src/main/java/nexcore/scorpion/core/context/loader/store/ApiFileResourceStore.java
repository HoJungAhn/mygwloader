...
public class ApiFileResourceStore implements ApiResouceStore{
	private Logger logger = LoggerFactory.getLogger(ApiFileResourceStore.class);
	private File rootPath;
	
	public ApiFileResourceStore(String rootPath){
		this.rootPath = new File(rootPath);
	}
	
	public ApiFileResourceStore(File rootPath){
