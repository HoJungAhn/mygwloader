...
public class ApiResourcesClassLoaderDelegator extends ClassLoader{
	private Logger logger = LoggerFactory.getLogger(ApiResourcesClassLoaderDelegator.class);
	private ApiResouceStore [] stores;
	...
	public ApiResourcesClassLoaderDelegator(ClassLoader parent, ApiResouceStore[] stores, Set<Pattern> acceptClasses){
		super(parent);
		this.stores = stores;
    ...
    protected URL findResource(String name) {
    	...
    	for (ResourceStore store : stores) {
    		if (store instanceof ApiResouceStore) {
    			classpath = ((ApiResouceStore) store).getRoot();
